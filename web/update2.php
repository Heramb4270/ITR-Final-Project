     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index1.html">Modern</a>
            </div>
            <!-- /.navbar-header -->
						...
						<div class="tab-pane active" id="horizontal-form">
							...
							<form  method="POST" >
								  ...
								  <label for="exampleInputEmail1">Name</label>
									<input type="text" name="name" value="<?php echo $row['name'];?>" id="exampleInputEmail1" placeholder="Your Name*" class="form-control"
									  required="" />
								  </div>
								  </tr>
								  <tr>
								  <div class="form-group">
									  ...
									  <input type="text" name="email"class="form-control" value="<?php echo $row['email'];?>" placeholder="Text input">
									  </div>
									  </tr>
									  <tr>
									<div class="form-group">
									<label for="subject">Subject</label>
									<input type="text" name="subject" value="<?php echo $row['subject'];?>" id="w3lSubect" placeholder="Subject*" class="form-control"
									  required="" />
									  </div>
									  </tr>
									  <tr>
									...
									<input type="text" name="url" id="w3lWebsite" value="<?php echo $row['url'];?>" placeholder="Website URL*" class="form-control"
									  required="" />
									  </div>
									  </tr>
									  <tr>
								  ...
								  <label for="message">Message</label>
									<textarea name="message" value="<?php echo $row['message'];?>" id="w3lMessage" placeholder="Type your message here*" class="form-control" required=""></textarea>
								  </div>
								  </tr>
								  <tr>
