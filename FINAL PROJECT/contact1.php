          ...
          <form method="post" class="signin-form">
            <div class="input-grids">
              ...
              <input type="text" name="subject" id="w3lSubect" placeholder="Subject*" class="contact-input"
                required="" />
              <input type="text" name="url" id="w3lWebsite" placeholder="Website URL*" class="contact-input" 
                required="" /> 
            </div>
            ...
            <div class="w3l-submit text-lg-right">
                <!-- <input type="submit" name="btn_submit" class="btn btn-style btn-primary" value="submit"> -->
            <button  class="btn btn-style btn-primary" name="btn_submit">Send Message</button>
            </div>
          </form>
        </div>
      </div>
...
if(isset($_POST["btn_submit"]))
{
	...
	$insert = mysqli_query($con,"insert into contact(name, email, subject, url, message) values('$name','$email','$subject','$url','$message')") or die(mysqli_error($con));
